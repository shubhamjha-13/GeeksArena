...
const ProblemPage = () => {
  ...
  // Changed state to store code for each language
  ...
  const handleEditorChange = (value) => {
    // Update only the current language's code
  ...
  const handleRun = async () => {
    ...
    try {
      const response = await axiosClient.post(`/submission/run/${problemId}`, {
        code: codeByLanguage[selectedLanguage], // Use current language's code
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="flex-1">
                <Editor
                  ...
                  value={codeByLanguage[selectedLanguage]} // Use current language's code
