          ...
          <div className="container mx-auto px-4 py-20">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-gray-300 mb-10 max-w-2xl">
                Train rigorously, solve real challenges, and sharpen your coding
                mind. LetLabs is your lab to practice and push past your limits
                — built for coders who want to lead.
              </p>
            ...
            <div className="lg:w-1/2">
              <div className="mb-12">
                ...
                <p className="text-xl text-gray-300 mb-8 max-w-3xl">
                  ...
                  workspace equips you with everything you need to code smarter,
                  faster, and better!
                </p>
                ...
                <div className="mb-12">
                  ...
                  <p className="text-gray-300 mb-6">
                    ...
                    challenges designed to sharpen your skills and prepare you
      ...
      <footer className="py-12 border-t border-gray-800">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-8 md:mb-0">
              ...
              <p className="text-gray-400 max-w-xs">
                The ultimate coding lab for developers to practice, compete, and
                excel.
              </p>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-500">
            <p>
              © 2023 LetLabs. All rights reserved. Designed for coders who want
              to lead.
            </p>
          </div>
        </div>
