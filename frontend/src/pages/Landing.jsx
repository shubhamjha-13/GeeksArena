          ...
          <div className="flex items-center">
            <div className="container mx-auto px-8 py-20 flex">
              <div className="max-w-3xl">
                ...
                <ScrambledText className="scrambled-text-demo text-4xl md:text-6xl font-bold leading-tight" radius={100} duration={1.2} speed={0.5} scrambleChars=".:">
                A <span style={{backgroundImage: `linear-gradient(to right, ${colors.join(", ")})`}}>Lab</span> where Coders Practice and Prove Themselves
                </ScrambledText>
