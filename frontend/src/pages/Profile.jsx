            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center bg-gray-800/50 p-3 rounded-xl">
                  ...
                  <p className="text-xl font-bold text-green-400">{user.problemSolved}</p>
                </div>
                <div className="text-center bg-gray-800/50 p-3 rounded-xl">
                  <p className="text-sm text-gray-300">Easy</p>
                  <p className="text-xl font-bold text-green-400">{problemStats.easySolved}</p>
                </div>
                <div className="text-center bg-gray-800/50 p-3 rounded-xl">
                  <p className="text-sm text-gray-300">Medium</p>
                  <p className="text-xl font-bold text-yellow-400">{problemStats.mediumSolved}</p>
                </div>
                <div className="text-center bg-gray-800/50 p-3 rounded-xl">
                  <p className="text-sm text-gray-300">Hard</p>
                  <p className="text-xl font-bold text-red-400">{problemStats.hardSolved}</p>
                </div>
              </div>
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between mb-1">
                    <span className="text-base font-medium text-green-400">Easy</span>
                  ...
                  <div className="w-full bg-gray-700 rounded-full h-2.5">
                    <div 
                      ...
                      style={{ width: `${calculateProgress(problemStats.easySolved)}%` }}
                    ></div>
                  </div>
                </div>
                ...
                <div>
                  <div className="flex justify-between mb-1">
                    <span className="text-base font-medium text-yellow-400">Medium</span>
                    <span className="text-sm font-medium text-gray-300">
                  ...
                  <div className="w-full bg-gray-700 rounded-full h-2.5">
                    <div 
                      ...
                      style={{ width: `${calculateProgress(problemStats.mediumSolved)}%` }}
                    ></div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="w-full bg-gray-700 rounded-full h-2.5">
                    <div 
                      ...
                      style={{ width: `${calculateProgress(problemStats.hardSolved)}%` }}
                    ></div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gray-800 rounded-2xl shadow-xl p-6">
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="text-sm font-medium text-indigo-400">{user.posts.length} posts</span>
              </div>
              ...
              {user.posts.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-400 mt-4">You haven't created any posts yet</p>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-lg font-bold text-white">{user.problemSolved}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-300">Posts Created</p>
                    <p className="text-lg font-bold text-white">{user.posts.length}</p>
                  </div>
                </div>
